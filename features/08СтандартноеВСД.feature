...
Сценарий: Создание Документации по реализации №00000000003 от 14.04.2022
		...
		*Создание ВСД по документу №00000000003 от 14.04.2022
			И В командном интерфейсе я выбираю "кб99 ВСД" "Интеграция ФГИС Ветис"
			Тогда открылось окно "кб99 Интеграция ФГИС Меркурий"
			И я нажимаю кнопку выбора у поля с именем 'ДатаНачалаОтбора'
			И в поле с именем 'ДатаНачалаОтбора' я ввожу текст "01.08.2000  0:00:00"
			...
			И таблица 'Партии' стала равной:
				...
				| '1' | 'Реализация товаров и услуг 00000000003 от 14.04.2022 12:30:02' | 'Ветчина'      | '12 Колбаса "Докторская" в/с' | '32299173 Колбаса "Докторская" в/с' | '200,000000' | '200,000000'          | ''                 | '2025-10-09'      |
