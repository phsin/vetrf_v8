...
Сценарий: 01 Создание продукции-элемента
	*01 Создание продукции-элемента
		...
		//"ВА_ПродукцияТест" в кавычках и больше никак
		...
		//ВА_ПродукцияТест без кавычек
		//'$Рандом$'
		//поставил 2 звёздочки, не понял вставить сюда значение переменной (1я* - номер продукции; 2я* - её имя т.е. '$Рандом$') 
		//Тогда открылось окно "* * (Продукция-элементы)" - рабочая, но и без неё пашет
	...
	*03 Создание соответствия
		...
		//"ВА_Продукция" в кавычках
		И в поле с именем 'ПродукцияЭлемент' я ввожу текст "$ВА_Прод_Рандом$" 
		//И из выпадающего списка с именем 'ПродукцияЭлемент' я выбираю по строке "ВА_Прод  '$Рандом$'" //при таком выборе почему-то берёт "Рандом с предыдущего запуска теста"
		//так он сам сгенерировал
		//И я нажимаю на кнопку с именем 'ФормаЗаписать'
