...
Сценарий: Создание документа ВСД2_Транзакция
	...
	// И я нажимаю кнопку выбора у поля "Получатель_ХозСубъект"
...
//	И я нажимаю на кнопку открытия поля "ТоварыПартия"
	//	И я нажимаю на кнопку открытия поля с именем 'ТоварыПартия'								
	//И в таблице "Товары" я активизирую поле с именем "ТоварыПартия"
	И я нажимаю кнопку выбора у поля с именем 'ТоварыПартия'
//	И В таблице "Товары" я нажимаю кнопку выбора у реквизита "ТоварыПартия"
		//И в таблице "Товары" я нажимаю кнопку выбора у реквизита "ТоварыПартия"
...
//	И в таблице "Маркировка" я завершаю редактирование строки
	...
	//И я нажимаю на кнопку 'ФормаОбщаяКомандаВСД_ОтправитьВСД'
