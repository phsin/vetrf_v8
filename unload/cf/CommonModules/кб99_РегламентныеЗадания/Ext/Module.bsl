	...
	Попытка
		...
		Для Каждого строкаВыборка Из МассивВходящихВСД Цикл
			...
			Если ИскатьДокументПрихода Тогда
				...
				ДокументПрихода = кб99_ВСД_Общий.Гашение_НайтиДокументПоступлениеТоваров( строкаВыборка.ДокВСД.ТтнДата, строкаВыборка.ДокВСД.ТтнНомер, строкаВыборка.Отправитель_Хозсубъект.ИНН );
