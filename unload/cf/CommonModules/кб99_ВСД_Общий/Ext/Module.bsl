...
//	НоваяСтрока.ЕдиницаИзмерения 		= НоваяСтрока.Партия.ЕдиницаИзмерения;
	...
	Попытка НоваяСтрока.РезультатыИсследований	= НоваяСтрока.Партия.vetDocument.РезультатыИсследований Исключение НоваяСтрока.РезультатыИсследований = ДокСсылка.РезультатыИсследований; КонецПопытки;
