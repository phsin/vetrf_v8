...
//
Функция СоздатьВременнуюТаблицуВСД()
...
//
Функция СоздатьВременнуюТаблицуСоответствия()
...
//
Функция СоздатьВременнуюТаблицуПлощадки()
...
//
Функция ПолучитьТекстПредставленияДокумента(ПрефиксПоля = "")
...
//
Процедура УстановитьПараметрыЗапросаПоДатамИОрганизациям(Запрос, ПараметрыФункции, ИспользоватьНачалоКонецДня = Ложь)
...
//
Процедура УстановитьПараметрПлощадкаОтправителяСклад(Запрос, ПараметрыФункции)
