...
Функция Преобразовать_СтрокаДата_в_XML(ДатаСтр) Экспорт
	...
	Если ЗначениеЗаполнено( год1 ) Тогда
		ТекстЗапроса = " <dt:year>"+ ОписаниеТипа.ПривестиЗначение(год1) +"</dt:year>";
	КонецЕсли;
	Если ЗначениеЗаполнено( мес1 ) Тогда
		ТекстЗапроса = ТекстЗапроса + " <dt:month>"+ ОписаниеТипа.ПривестиЗначение(мес1) +"</dt:month> ";
	КонецЕсли;
	Если ЗначениеЗаполнено( день1 ) Тогда
		ТекстЗапроса = ТекстЗапроса + " <dt:day>"+ ОписаниеТипа.ПривестиЗначение(день1) +"</dt:day>";
	КонецЕсли;
