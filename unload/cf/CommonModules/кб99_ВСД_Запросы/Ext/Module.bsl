...
//КонецФункции
Функция ДатаСтрокаГод( ВыбСтрока )
	зн = Лев( ВыбСтрока, 4);
...
//КонецФункции
Функция ДатаСтрокаМесяц( ВыбСтрока )
	
	зн = Сред( ВыбСтрока, 6, 2 );
	Если ЗначениеЗаполнено( зн ) Тогда 
...
//КонецФункции
Функция ДатаСтрокаЧисло( ВыбСтрока )
	
	зн = Сред( ВыбСтрока, 9, 2 );
	Если ЗначениеЗаполнено( зн ) Тогда 
...
Функция ДатаСтрокаЧас( ВыбСтрока )
	
	зн = Сред( ВыбСтрока, 12, 2 );
	Если ЗначениеЗаполнено( зн ) Тогда 
