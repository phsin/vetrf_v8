...
Процедура ПроверитьПроизводствоПередОтправкой(Результат, ПараметрыОрганизации, ДокСсылка, тзПартииСписания)
	...
	Если ЗначениеЗаполнено(Комментарий) Тогда
		кб99_ВСД.СообщитьИнфо(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку("В документе %1 содержатся ошибки: %2. Документ не отправлен.", ДокСсылка, СокрЛП(Комментарий)));
