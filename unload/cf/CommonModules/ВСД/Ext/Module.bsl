// http://www.kb99.pro версия 1.7.14 от 09/02/2019
...
Функция НеИспользуемУдалитьПолучитьПутьКСправкеВИКИ(ВызывающийОбъект) Экспорт
	ИмяОбъекта = Строка(ТипЗнч(ВызывающийОбъект)); //Синоним
	
	Если ИмяОбъекта = "ВСД2 транзакция" Тогда
		ПутьКСправке = "https://redmine.kb99.pro/projects/vsd_1c/wiki/%D0%92%D0%A1%D0%942_%D0%A2%D1%80%D0%B0%D0%BD%D0%B7%D0%B0%D0%BA%D1%86%D0%B8%D1%8F";
	ИначеЕсли ИмяОбъекта = "ВСД2 производство" Тогда
		ПутьКСправке = "https://redmine.kb99.pro/projects/vsd_1c/wiki/%D0%92%D0%A1%D0%942_%D0%9F%D1%80%D0%BE%D0%B8%D0%B7%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%BE";
	ИначеЕсли ИмяОбъекта = "ВСД2 инвентаризация" Тогда
		ПутьКСправке = "https://redmine.kb99.pro/projects/vsd_v8/wiki/%D0%92%D0%A1%D0%942_%D0%98%D0%BD%D0%B2%D0%B5%D0%BD%D1%82%D0%B0%D1%80%D0%B8%D0%B7%D0%B0%D1%86%D0%B8%D1%8F";
	ИначеЕсли ИмяОбъекта = "ВСД2 объединение партий" Тогда
		ПутьКСправке = "https://redmine.kb99.pro/projects/vsd_v8/wiki/%D0%92%D0%A1%D0%942_%D0%9E%D0%B1%D1%8A%D0%B5%D0%B4%D0%B8%D0%BD%D0%B5%D0%BD%D0%B8%D0%B5%D0%9F%D0%B0%D1%80%D1%82%D0%B8%D0%B9";
	ИначеЕсли ИмяОбъекта = "ВСД2 лабораторные исследования" Тогда
		ПутьКСправке = "https://redmine.kb99.pro/projects/vsd_v8/wiki/%D0%92%D0%A1%D0%942_%D0%9B%D0%B0%D0%B1%D0%BE%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BD%D1%8B%D0%B5%D0%98%D1%81%D1%81%D0%BB%D0%B5%D0%B4%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D1%8F";
	ИначеЕсли ИмяОбъекта = "Входящий ВСД" Тогда
		ПутьКСправке = "https://redmine.kb99.pro/projects/vsd_v8/wiki/%D0%92%D0%A1%D0%942_%D0%92%D1%85%D0%BE%D0%B4%D1%8F%D1%89%D0%B8%D0%B9";
	ИначеЕсли ИмяОбъекта = "ВСД транзакция" Тогда
		ПутьКСправке = "https://redmine.kb99.pro/projects/vsd_v8/wiki/%D0%92%D0%A1%D0%94_%D0%A2%D1%80%D0%B0%D0%BD%D0%B7%D0%B0%D0%BA%D1%86%D0%B8%D1%8F";
	ИначеЕсли ИмяОбъекта = "ВСД2" Тогда
		ПутьКСправке = "https://redmine.kb99.pro/projects/vsd_v8/wiki/%D0%92%D0%A1%D0%942";
	ИначеЕсли ИмяОбъекта = "ВСД" Тогда
		ПутьКСправке = "https://redmine.kb99.pro/projects/vsd_v8/wiki/%D0%92%D0%A1%D0%94";
	// Справочники	
	ИначеЕсли ИмяОбъекта = "ВСД хоз субъект" Тогда
		ПутьКСправке = "https://redmine.kb99.pro/projects/vsd_v8/wiki/%D0%92%D0%A1%D0%94_%D0%A5%D0%BE%D0%B7%D0%A1%D1%83%D0%B1%D1%8A%D0%B5%D0%BA%D1%82";
	ИначеЕсли ИмяОбъекта = "ВСД площадка" Тогда
		ПутьКСправке = "https://redmine.kb99.pro/projects/vsd_v8/wiki/ВСД_Площадка";
	ИначеЕсли ИмяОбъекта = "ВСД партия" Тогда
		ПутьКСправке = "https://redmine.kb99.pro/projects/vsd_v8/wiki/ВСД_Партия";
	ИначеЕсли ИмяОбъекта = "ВСД продукция элемент" Тогда
		ПутьКСправке = "https://redmine.kb99.pro/projects/vsd_v8/wiki/ВСД_Продукция_Элемент";
	ИначеЕсли ИмяОбъекта = "" Тогда
		ПутьКСправке = "";
	Иначе
		ПутьКСправке = "https://redmine.kb99.pro/projects/vsd_v8/wiki";
	КонецЕсли;
