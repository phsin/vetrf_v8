...
Функция НайтиХозСубъект(Контрагент) Экспорт
	...
	Если кб99_ВСД_Общий.ЕстьРеквизитИлиСвойствоОбъекта(Контрагент, "ГоловнойКонтрагент") Тогда
...
Процедура ОтправитьВСДвГИС(Знач ДокСсылка, АдресХранилища = Неопределено) Экспорт
	...
	Если кб99_ВСД_Общий.ЕстьРеквизитИлиСвойствоОбъекта(ДокСсылка, "Организация") Тогда 
