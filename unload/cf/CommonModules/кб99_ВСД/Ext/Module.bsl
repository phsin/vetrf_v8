...
Процедура СохранитьАктуальнуюВерсию(ОтветСервера, Организация) Экспорт
	
	кб99_ВСД_Отправка.СохранитьАктуальнуюВерсию(ОтветСервера, Организация);
	
КонецПроцедуры

Функция ПолучитьАктуальнуюВерсию(Организация) Экспорт
	
	Возврат кб99_ВСД_Отправка.ПолучитьАктуальнуюВерсию(Организация);
