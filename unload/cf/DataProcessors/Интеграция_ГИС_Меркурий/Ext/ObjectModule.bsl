...
Процедура ЗаполнитьТаблицуПартий() Экспорт
	...
	Для Каждого стрНужныеПартии Из ВремПартии Цикл
		...
		СтрокиПартий = ВСД.ПодобратьПартииПоПродукцияЭлемент( СписокКонстант, тзАктуальныхПартий, стрНужныеПартии.ВСД_Продукция_Элемент, стрНужныеПартии.КоличествоСписания );
