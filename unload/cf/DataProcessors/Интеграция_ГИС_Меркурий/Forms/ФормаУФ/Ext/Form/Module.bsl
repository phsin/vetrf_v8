...
Процедура кнЗаполнитьТаблицуПартий(Команда)
	...
	ВыбЭлемент = ЭтаФорма.ВыбратьИзМеню(СписокВыбора);
	...
	ЗаполнитьТаблицуПартий( ВыбЭлемент.Значение );
	ПоказатьОповещениеПользователя("Выполнено");
...
Процедура кнОтправитьВСД(Команда)
	...
	Результат = ОтправитьВСД_НаСервере( ВыбЭлемент.Значение );	
