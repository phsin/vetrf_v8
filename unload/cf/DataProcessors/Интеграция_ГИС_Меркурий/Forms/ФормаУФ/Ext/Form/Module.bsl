	...
	Для Каждого Стр Из ДокОбъект.Товары Цикл
		...
		Если ЗначениеЗаполнено(ДатаСрокГодности2) Тогда
			Если ДатаСрокГодности2 - Объект.СрокГодностиДней * 86400 <= ТекущаяДата() Тогда
				кб99_ВСД.СообщитьИнфо("В документе " + ДокОбъект + " Выбранна просроченная партия По срокам годности2 (менее "+ Объект.СрокГодностиДней +" дней до окончания срока) в строке "+Стр.НомерСтроки+"!");
				Рез = Ложь;
		...
		Иначе
			Если ДатаСрокГодности1 - Объект.СрокГодностиДней * 86400 <= ТекущаяДата() Тогда
				кб99_ВСД.СообщитьИнфо("В документе " + ДокОбъект + " Выбранна просроченная партия По срокам годности (менее "+ Объект.СрокГодностиДней +" дней до окончания срока) в строке "+Стр.НомерСтроки + "!");
				Рез = Ложь;
