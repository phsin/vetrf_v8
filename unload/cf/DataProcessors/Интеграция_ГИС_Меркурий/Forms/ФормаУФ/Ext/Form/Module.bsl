...
Процедура ЗаполнитьТаблицуПартийНаСервере( ЗнакСортировки=Неопределено ) Экспорт
	...
	КонецЦикла;
	ВремПартии.Свернуть("ВСД_Продукция_Элемент, СерияНоменклатуры, Номенклатура, Документ, ТермУсловияПеревозки","КоличествоСписания");    // !!!
	...
	Для Каждого стрНужныеПартии Из ВремПартии Цикл
		...
		СтрокиПартий = кб99_ВСД.ПодобратьПартииПоПродукцияЭлемент( ПараметрыОрганизации, тзАктуальныхПартий, стрНужныеПартии.ВСД_Продукция_Элемент, стрНужныеПартии.КоличествоСписания, стрНужныеПартии.СерияНоменклатуры, стрНужныеПартии.Номенклатура ); 
