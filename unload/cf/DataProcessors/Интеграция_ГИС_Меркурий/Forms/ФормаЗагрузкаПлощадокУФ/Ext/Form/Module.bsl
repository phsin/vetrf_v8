...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//	//ЗаполнитьЗначениеСвойств( Объект, ПараметрыОрганизации );
	//Исключение 
...
Процедура кнВыполнитьПоискСервер( СписокУсловий )
	...
	МассивПлощадок = ВСД_Запросы.Площадки_ЗагрузитьПоУсловиям( ПараметрыОрганизации, СписокУсловий );
	
	Объект.Площадки.Очистить();
	//ЗаполнитьЗначенияСвойств( Объект.Площадки, МассивПлощадок );
...
Процедура кнСохранитьНаСервере()
	Для Каждого строкаПлощадка из Объект.Площадки Цикл
		Если строкаПлощадка.Отметка Тогда 
			...
			//Объект_ВСД_Площадка.GUIDХозСубъекта = строкаПлощадка.GUIDХозСубъекта;
