...
Процедура кнЗаполнитьУсловияПеревозкиНаСервере()
	...
	Запрос.Текст = 
		...
		|ГДЕ
		|	ВСД2_транзакцияУсловияПеревозки.GUID <> """"
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		Для Каждого Стр Из ДокОбъект.УсловияПеревозки Цикл
			...
			ДанныеЗаполнения.Вставить("Наименование"	, Стр.Название);
			ДанныеЗаполнения.Вставить("GUID"			, Стр.GUID);
			ДанныеЗаполнения.Вставить("UUID"			, Стр.UUID);
			ДанныеЗаполнения.Вставить("ВидПродукции"	, Стр.ВидПродукции);
			ДанныеЗаполнения.Вставить("Решение"			, Стр.Решение);
			...
			Если ЗначениеЗаполнено(УсловиеПеревозки) Тогда
				...
				Стр.GUID			 = Неопределено;
				Стр.UUID			 = Неопределено;
				Стр.ВидПродукции	 = Неопределено;
				Стр.Решение			 = Неопределено;
