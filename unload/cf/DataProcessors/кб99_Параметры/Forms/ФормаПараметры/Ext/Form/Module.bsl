...
Процедура ВходящиеПроверятьДатуИзготовленияПриИзменении(Элемент)
	...
	Если Объект.ВходящиеПроверятьДатуИзготовления Тогда 
		ЭтотОбъект.Элементы.ВходящиеПроверятьДатуИзготовленияКоличествоДней.Доступность = 1;
	Иначе
		ЭтотОбъект.Элементы.ВходящиеПроверятьДатуИзготовленияКоличествоДней.Доступность = 0;
	КонецЕсли;		
