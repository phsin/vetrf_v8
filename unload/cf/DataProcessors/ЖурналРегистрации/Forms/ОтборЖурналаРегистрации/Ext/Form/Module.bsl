...
Процедура НесколькоЗначенийПриИзменении(Элемент)
	...
	ТекущиеДанные = ЭтаФорма[ИмяДанных];
	ТекущийСписок = ЭтаФорма[ИмяСпискаДанных];
	
	Если ОдноЗначение Тогда
		ЭтаФорма[ИмяДанных] = ?(ТекущийСписок.Количество() = 0,
...
Процедура КомментарийПриИзменении(Элемент)
	...
	ОбновитьПолеКомментарий(ЭтаФорма);
...
Процедура КомментарийИзменениеТекстаРедактирования(Элемент, Текст, СтандартнаяОбработка)
	...
	ОбновитьПолеКомментарий(ЭтаФорма, Текст);
