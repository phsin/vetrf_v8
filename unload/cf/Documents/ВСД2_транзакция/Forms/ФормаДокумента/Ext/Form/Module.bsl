...
Процедура ЗаписатьСоответсвиеХозСубъекта(ДокументОснование, Получатель_ХозСубъект)
	...
	Если ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ПеремещениеТоваров")
...
Процедура ЗаписатьСоответсвиеПлощадки(ДокументОснование, Площадка)
	...
	ИначеЕсли СписокКонстант["РеквизитГрузополучатель"] = 2 Тогда
        // Партнер
        Если ОбщегоНазначения.ЕстьРеквизитОбъекта("Партнер", ДокументОснование.Метаданные()) Тогда 						
	...
	ИначеЕсли СписокКонстант["РеквизитГрузополучатель"] = 3 Тогда
        // Грузополучатель
        Если ОбщегоНазначения.ЕстьРеквизитОбъекта("Грузополучатель", ДокументОснование.Метаданные()) Тогда 						
	...
	Иначе	
		// Договор
        Если ОбщегоНазначения.ЕстьРеквизитОбъекта("Договор", ДокументОснование.Метаданные()) Тогда 						
