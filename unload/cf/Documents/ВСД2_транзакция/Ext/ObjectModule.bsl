...
Функция ПолучитьДанныеДляСозданияВСДТранзакции( ПараметрыОрганизации ) 
	...
	Иначе
		...
		Если кб99_ВСД.ЕстьРеквизитОбъекта("Контрагент", ДокументОснование.Метаданные()) Тогда 						
		...
		Иначе
			//Адрес доставки
			Если кб99_ВСД.ЕстьРеквизитОбъекта("АдресДоставки", ДокументОснование.Метаданные()) Тогда 						
				_Получатель_Площадка = кб99_ВСД.НайтиПлощадкуПоКонтрагенту(ДокументОснование.АдресДоставки);
			Иначе
	...
	ИначеЕсли ( ТипЗнч(ДанныеЗаполнения) = Тип("Структура") ) Тогда 
		...
		Иначе
			...
			Если ПараметрыДокумента.Свойство("ДокОснование") Тогда 
				...
				Если кб99_ВСД.ЕстьРеквизитОбъекта("Организация", ДокументОснование.Метаданные()) Тогда 			
					Организация = ДокументОснование.Организация;
				Иначе
