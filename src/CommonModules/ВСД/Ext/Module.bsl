...
Функция ЗагрузитьПараметры( _Организация  ) Экспорт
  ...
  //   КлючНастроек = "НастройкиВСД";
	 ...
	 Попытка
         ...
         СписокПараметров = ХранилищеОбщихНастроек.Загрузить(КлючОбъекта,"НастройкиВСДПоПользователю",,ВладелецНастроек); // на пользователя
		...
		ИначеЕсли СписокПараметров Тогда
//		 	СписокПараметров = ХранилищеОбщихНастроек.Загрузить(КлючОбъекта,Строка(КлючНастроек),,ВладелецНастроек); // на пользователя
		 	СписокПараметров = ХранилищеОбщихНастроек.Загрузить(КлючОбъекта,Строка(_Организация),,ВладелецНастроек); // на пользователя
		Иначе
			СписокПараметров = ХранилищеОбщихНастроек.Загрузить(КлючОбъекта,Строка(_Организация),,_Организация);
		КонецЕсли;
...
//    КлючНастроек = "НастройкиВСД";
	...
	ХранилищеОбщихНастроек.Сохранить(КлючОбъекта,  "НастройкиВСДПоПользователю", _НастройкиДляТекущегоПользователя, , ИмяПользователя);
...
//		ХранилищеОбщихНастроек.Сохранить(КлючОбъекта,  Строка(КлючНастроек), СписокКонстант, , ИмяПользователя);
		ХранилищеОбщихНастроек.Сохранить(КлючОбъекта,  Строка(_Организация), СписокКонстант, , ИмяПользователя);
	Иначе
