...
//			ТЗВСД.термическоесостояние = Число(ТермУсловия.Представление);
		...
		ДатаИзготовления1="";	ДатаИзготовления=""; ДатаИзготовления2="";		
		Попытка Дата_из_XML(batch.dateOfProduction, ДатаИзготовления1, ДатаИзготовления2, ДатаИзготовления ); исключение КонецПопытки;
		...
		ДатаСрокГодности1=""; ДатаСрокГодности2=""; ДатаСрокГодности="";
		Попытка Дата_из_XML(batch.expiryDate, ДатаСрокГодности1, ДатаСрокГодности2, ДатаСрокГодности ); исключение КонецПопытки;
