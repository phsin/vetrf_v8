...
//Функция ЗагрузитьКомпонетуНаСервере( ПараметрыОбъекта )
...
Процедура Инициализация( ) Экспорт
	...
	иначе
		...
		//КомпонентаНаСервере = ЗагрузитьКомпонетуНаСервере( ЭтотОбъект );
		КомпонентаНаСервере = ВСД.ЗагрузитьComКомпонентуНаСервере( ЭтотОбъект );
//		МодульПереопределения = ПодключитьМодульПереопределения(ПолноеИмяФайлаПереопределения);
