...
Процедура ОбновитьДанныеКолонокТовары()
	...
	Для Каждого Стр Из Объект.Товары Цикл
		Если Выборка.НайтиСледующий(Стр.Партия,"Партия") Тогда
			Стр.ДатаСрокГодности = Выборка.ДатаСрокГодности;
			Стр.ДатаСрокГодности2 = Выборка.ДатаСрокГодности2;
			Стр.ДатаИзготовления = Выборка.ДатаИзготовления;
			Стр.ДатаИзготовления2 = Выборка.ДатаИзготовления2;			
		Иначе
