...
Процедура ЗагрузитьПлощадкиПоСпискуДокументов(Команда)
	...
	Если Команда.имя = "ЗагрузитьПлощадкиПоСпискуДокументовНаименование" тогда
		Если Объект.флИспользоватьВнешнююОбработку Тогда
			ОткрытьФорму("ВнешняяОбработка.Интеграция_ГИС_Меркурий.Форма.ФормаЗагрузкаПлощадокУФ");
		Иначе
			ОткрытьФорму("Обработка.Интеграция_ГИС_Меркурий.Форма.ФормаЗагрузкаПлощадокУФ");
		КонецЕсли;
		Возврат;
